...
title: Parachain Campaign for Tanganika Network (DataHighway's Kusama Parachain)
sidebar_label: Parachain Campaign for Tanganika Network (DataHighway's Kusama Parachain)
---
import useBaseUrl from '@docusaurus/useBaseUrl';

## Terms and Conditions of the Tanganika Network Parachain Campaign

:::caution
If the contents of the <a href={useBaseUrl("/crowdloans/crowdloan-tanganika-terms.md")} target="_blank">Terms and Conditions</a> document is **"Not yet available"** then please do not yet participate.
:::

:::caution
If have not fully read and understood the <a href={useBaseUrl("/crowdloans/crowdloan-tanganika-terms.md")} target="_blank">Terms and Conditions</a> of this Tanganika Network Parachain Campaign, and/or do not agree to them, then please do not participate.
:::
...
## How to Contribute to the Tanganika Network Crowdloan?
...
The [Spreehafen Parachain Testnet on Rococo](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Fspreehafen.datahighway.com#/explorer). Rococo uses ROC tokens.
