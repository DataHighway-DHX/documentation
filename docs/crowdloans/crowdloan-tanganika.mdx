...
Distributed as a % of your contribution to the pool (your KSM Contribution / Total KSM Contributed) * **300k DHX** tokens. If your % contribution results in a fraction of DHX tokens then the corresponding DHX reward will be rounded down to the nearest whole number in DHX.
